...
class Memory:
    def __init__(self):
        ...
        self.rewards = []
        self.is_terminals = []
        self.is_truncated = []  # ДОБАВЬТЕ ЭТО!
    
    def store(self, state, action_final, log_prob, reward, done, is_truncated):
        ...
        self.is_truncated.append(is_truncated)
    ...
    def copy_to_tensors(self):
        ...
        self.is_truncated = torch.tensor(self.is_truncated, device=Constants.device)
