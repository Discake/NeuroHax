...
class SharedMemoryExperienceCollector:
    def __init__(self, num_workers=20, max_steps_per_worker=1000):
        ...
        self.data_size = num_workers * max_steps_per_worker * 5  # (state, action, reward, logp, done)
        self.step_size = None
    ...
    def create_shared_memory_blocks(self, state_size, action_size):
        ...
        for i in range(self.num_workers):
            ...
            # Сохранить reference для cleanup
            # shm.close()            
    ...
    def worker_shared_memory(self, step_size, env_map : Map, state_dict, shm_name, process_id):
        ...
        try:
            ...
            # step_size = 128  # state(40) + action(4) + reward(1) + next_state(40) + done(1) + padding
            ...
            # print(f"experience_buffer.shape = {experience_buffer.shape}")
